...
module.exports.run = async (bot, message, args) => {
    ...
    try {
        ...
        message.reply("**Pesquise o nome de uma pessoa e lhe darei a foto dela**");
        message.reply("**Eu pesquisei por todo lugar e so achei essa foto**");
        message.channel.send("https://i.imgur.com/8D3OGlQ.jpeg");
