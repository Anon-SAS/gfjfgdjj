...
module.exports.run = async (bot, message, args) => {
    ...
    try {
        ...
        message.author.send("`help, pesquisar, qi, lol, cartão, cep, gay, adm, ban, raider, ping, eval, clear, invite, pack, hack, wordlist, email.`");
        message.author.send("**Somente o dono**");
        message.author.send("`adm, ban, eval.`");
        message.author.send("https://tenor.com/view/hack-pc-guy-fawkes-hacker-gif-17047231");
	message.channel.send('**Enviado no PV**')
        message.delete();
