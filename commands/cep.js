...
module.exports.run = async (bot, message, args) => {
    ...
    try {
        ...
        message.channel.send("**Cep:`77816-250`,| `78132-315`,| `72885-882`,| `26140-448`,| `69903-082`,| `49072-700`,| `79097-511`,| `59625-620`,| `58037-530`,| `76901-394`.**");
        message.reply("Esses são todos os ceps gerados.");
