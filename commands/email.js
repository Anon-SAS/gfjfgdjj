...
module.exports.run = async (bot, message, args) => {
    ...
    try {
        ...
        message.channel.send("**Email:`babosa3612@biohorta.com`,| `badosa36@biohorta.com`,| `faxoh94187@hyprhost.com`,| `rogab57641@biohorta.com`.**");
        message.reply("Esses são todos os emails gerados ate agora.");
